...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DomainNameEndpointConfiguration) DeepCopyInto(out *DomainNameEndpointConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DomainNameEndpointConfiguration.
func (in *DomainNameEndpointConfiguration) DeepCopy() *DomainNameEndpointConfiguration {
	if in == nil {
		return nil
	}
	out := new(DomainNameEndpointConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DomainNameStatus) DeepCopyInto(out *DomainNameStatus) {
	*out = *in
	...
	if in.DomainNameConfigurations != nil {
		in, out := &in.DomainNameConfigurations, &out.DomainNameConfigurations
		*out = make([]*DomainNameEndpointConfiguration, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(DomainNameEndpointConfiguration)
